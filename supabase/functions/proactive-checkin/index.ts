...
serve(async (req) => {
  ...
  // 2. If it's been more than 1 hour and the last message was from the user
  // OR if it's been more than 3 hours and Karouko wants to check in again
  if (diffHours >= 1) {
    console.log("[proactive-checkin] User has been away. Generating follow-up...");
    ...
    // 4. (Optional) Trigger Push Notification logic here
